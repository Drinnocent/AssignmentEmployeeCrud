...
import za.gov.sars.employeeCrud.common.DatasourceUtility;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"za.gov.sars.employeeCrud.persistence"}, transactionManagerRef = "transactionManager")
@ComponentScan(basePackages = {"za.gov.sars.employeeCrud.service"})
...
public class TestDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("za.gov.sars.employeeCrud.domain");
